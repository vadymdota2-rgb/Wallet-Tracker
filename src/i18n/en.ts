...
export const en = {
  ...
  ai_gate_auc: "AUC {v} — needs {need} or more",
  ai_gate_else: "Until all three hold, the formula does the work.",
  ai_gate_loss: "Loss {v} — must be below {need}",
  ai_gate_title: "What it takes to be accepted",
  ai_gate_wf: "Rolling check {v} — needs {need} or more",
  ai_gate_wf_min: "weakest stretch {v} — needs {need} or more",
  ai_gate_wf_none: "Rolling check not computed yet: {n} of {need} samples",
  ...
  ai_wf_hint: "the same check on several stretches of time in a row",
  ai_why: "Why",
