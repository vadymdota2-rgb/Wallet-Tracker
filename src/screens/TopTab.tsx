 ...
 * BSC собирается из цен DEX на момент покупки — часть монет куплена давно и
 * по ценам, которых уже не достать, и порог отсечения там всего десять
 * долларов оборота: доска получается витриной случайностей. Абсолютный PnL
 * при этом остаётся верным — он складывается из тех же сделок, но без
 * деления на кривой знаменатель.
 *
 * У фьючерсов иначе: ROI считается от маржи, которую биржа сообщает точно,
 * поэтому там доска есть.
 */
