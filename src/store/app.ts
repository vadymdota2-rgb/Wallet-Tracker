...
/* «liq» остаётся в наборе, хотя плитки у него больше нет: у кого-то раздел
   ликвидаций выбран и сохранён в браузере, и без него такой человек открыл бы
   аналитику с пустым экраном. */
export type BigView = "flow" | "spot" | "perp" | "liq" | "fund" | "rot" | "ls";
/** Окна потока: часы. */
