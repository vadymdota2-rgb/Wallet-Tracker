...
或从浏览器/分析服务粘贴地址。`,add_wallet_tracking_enabled:"已开启跟踪。",ai_acc:"模型准确率",ai_auc_hint:"0.50 等于抛硬币，1.00 是完美",ai_avoid:"回避",ai_btn:"🧠 Cortex",ai_buy:"买入",ai_collecting:"正在收集结果",ai_conf:"把握",ai_empty:"该时段独立钱包不足。",ai_entry:"📍 入场",ai_expire:"⏳ 有效",ai_expired:"⌛ 已过期",ai_gate_auc:"AUC {v} — 需要 {need} 以上",ai_gate_else:"三条未同时满足前，由公式工作。",ai_gate_loss:"损失 {v} — 需低于 {need}",ai_gate_title:"被采用需要满足",ai_gate_wf:"滚动检验 {v} — 需要 {need} 以上",ai_gate_wf_none:"滚动检验尚未计算：样本 {n} / {need}",ai_hint:`Cortex 是一个神谕：一个训练过的模型，估计价格跟随你关注的钱包的概率。当许多独立钱包朝同一方向移动时，它给出一个数字。
