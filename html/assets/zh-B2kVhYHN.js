...
或从浏览器/分析服务粘贴地址。`,add_wallet_tracking_enabled:"已开启跟踪。",ai_acc:"模型准确率",ai_auc_hint:"0.50 等于抛硬币，1.00 等于毫无差错",ai_avoid:"回避",ai_btn:"🧠 Cortex",ai_buy:"买入",ai_collecting:"正在收集结果",ai_conf:"把握",ai_contract:"合约",ai_empty:"该时段独立钱包不足。",ai_entry:"📍 入场",ai_expire:"⏳ 有效",ai_expired:"⌛ 已过期",ai_ft_accel:"资金流加速",ai_ft_both:"两个市场都有",ai_ft_breadth:"市场广度",ai_ft_btc24:"一天的比特币",ai_ft_btcvol:"比特币波动率",ai_ft_fromlow:"距周内低点",ai_ft_fund:"资金费率",ai_ft_fundz:"资金费率对比自身一周",ai_ft_hour:"一天中的小时",ai_ft_liqoi:"爆仓与持仓量之比",ai_ft_oivlm:"持仓量与成交额之比",ai_ft_ret1:"一小时涨跌",ai_ft_ret24:"一天涨跌",ai_ft_ret6:"六小时涨跌",ai_ft_ticket:"平均单笔规模",ai_ft_tohigh:"距周内高点",ai_ft_trades:"成交笔数",ai_ft_trend:"相对均线的趋势",ai_ft_vlm24:"一天成交额",ai_ft_vol24:"一天波动率",ai_ft_voljump:"波动率跳升",ai_gate_auc:"区分上涨与下跌：{v} — 需要 {need} 以上",ai_gate_else:"三项都达标之前，信号由公式计算。",ai_gate_loss:"估计误差：{v} — 需低于 {need}",ai_gate_title:"启用还需要什么",ai_gate_wf:"在不同时期都站得住：{v} — 需要 {need} 以上",ai_gate_wf_min:"最弱的一段 {v} — 需要 {need} 以上",ai_gate_wf_none:"跨时期检验：满 {need} 个结果后开始，现在 {n} 个",ai_hint:`Cortex 是一个神谕：一个训练过的模型，估计价格跟随你关注的钱包的概率。当许多独立钱包朝同一方向移动时，它给出一个数字。
