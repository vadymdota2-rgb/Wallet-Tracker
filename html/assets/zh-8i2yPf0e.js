...
或从浏览器/分析服务粘贴地址。`,add_wallet_tracking_enabled:"已开启跟踪。",ai_acc:"模型准确率",ai_avoid:"回避",ai_btn:"📡 Cortex",ai_buy:"买入",ai_conf:"把握",ai_empty:"该时段独立钱包不足。",ai_entry:"📍 入场",ai_expire:"⏳ 有效",ai_expired:"⌛ 已过期",ai_hint:`对跟踪钱包的资金流评分。
看谁在买、范围有多广，并加上市场：波动率及其跳升、趋势、RSI、资金费率、未平仓量、清算、比特币状态。

这是筛选，不是预测。价位来自波动率，风险是本金的一部分，不是指令。`,ai_hist_avg:"平均波动：",ai_hist_btn:"📜 历史",ai_hist_empty:"暂无已完成信号。",ai_hist_hours:"小时前",ai_hist_none:"都没有",ai_hist_plans:"已结束计划：",ai_hist_rate:"命中率：",ai_hist_sl:"止损",ai_hist_title:"信号历史",ai_hist_tp:"达标",ai_horizon:"周期24小时",ai_long:"做多",ai_market:"市价入场",ai_mode_formula:"公式 · 模型仍在学习",ai_mode_model:"模型",ai_none_now:"目前没有币种通过筛选",ai_not_passed:"模型尚未采用",ai_p_up:"24小时上涨概率",ai_perp:"合约",ai_risk:"风险",ai_sell:"卖出",ai_short:"做空",ai_spot:"现货",ai_st_acc:"准确率：",ai_st_base:"基准",ai_st_btn:"🧠 模型",ai_st_cal:"校准：",ai_st_coin:"抛硬币",ai_st_gate:"门槛",ai_st_loss:"损失：",ai_st_ready:"已完成结果：",ai_st_samples:"样本",ai_st_title:"模型状态",ai_st_top:"主要权重：",ai_st_trees:"棵树",ai_st_untrained:"尚未训练 — 使用公式。",ai_st_wf:"滚动检验：",ai_stop:"🛑 止损",ai_take:"🎯 目标",ai_take_one:"🎯 目标",ai_title:"Cortex",ai_trade_hint:"资金流评分。非投资建议。",ai_w1h:"1时",ai_w24:"24小时",ai_w30:"30天",ai_w6h:"6时",ai_w7:"7天",ai_wait_bot:"机器人尚未发来信号",ai_why:"原因",ai_why_breadth:"许多钱包",ai_why_flow:"净流向",ai_why_lev:"杠杆",ai_why_liq:"池流动性",ai_why_liqskew:"清算偏斜",ai_why_oi:"未平仓",ai_why_rsi:"RSI",ai_why_share:"不是单鲸",ai_why_top:"流向中的前100",ai_why_topdir:"头部方向",ai_why_vol:"成交量",alert_add_liquidity:"添加流动性",alert_amount:"金额",alert_arbitrage:"套利",alert_avg_entry:"平均成本",alert_bridge_in:"跨链转入",alert_bridge_out:"跨链转出",alert_buy:"买入",alert_buy_price:"买入价",alert_collect_fees:"收取手续费",alert_contract:"合约",alert_prior_ago:"前",alert_prior_buy:"上次买入",alert_qty:"数量",alert_received:"收入",alert_remove_liquidity:"移除流动性",alert_sell:"卖出",alert_sell_price:"卖出价",alert_spent:"支出",alert_token:"代币",alert_trade_pnl:"交易盈亏",alert_transaction:"交易",alert_transfer:"转账",alert_unwrap:"UNWRAP",alert_wallet:"钱包",alert_wrap:"WRAP",already_tracking:"⚠️ 您已在跟踪该钱包。",already_tracking_retry:`⚠️ 您已在跟踪该钱包。
