...
或从浏览器/分析服务粘贴地址。`,add_wallet_tracking_enabled:"已开启跟踪。",ai_acc:"模型准确率",ai_avoid:"回避",ai_btn:"📡 Sonar",ai_buy:"买入",ai_conf:"把握",ai_empty:"该时段独立钱包不足。",ai_entry:"📍 入场",ai_expire:"⏳ 有效",ai_expired:"⌛ 已过期",ai_hint:`对追踪钱包的资金流评分。
关注谁在买入以及范围有多广：成交额、钱包数量、集中度、加速度、前100参与、资金费率、市场状态。

这是筛选，不是预测。价位来自波动率，风险是本金的一部分，不是指令。`,ai_hist_avg:"平均波动：",ai_hist_btn:"📜 历史",ai_hist_empty:"暂无已完成信号。",ai_hist_hours:"小时前",ai_hist_plans:"已结束计划：",ai_hist_rate:"命中率：",ai_hist_sl:"止损",ai_hist_title:"信号历史",ai_hist_tp:"达标",ai_horizon:"周期24小时",ai_long:"做多",ai_market:"市价入场",ai_mode_formula:"公式 · 模型仍在学习",ai_mode_model:"模型",ai_perp:"合约",ai_risk:"风险",ai_sell:"卖出",ai_short:"做空",ai_spot:"现货",ai_st_acc:"准确率：",ai_st_btn:"🧠 模型",ai_st_cal:"校准：",ai_st_ready:"已完成结果：",ai_st_samples:"样本",ai_st_title:"模型状态",ai_st_top:"主要权重：",ai_st_untrained:"尚未训练 — 使用公式。",ai_stop:"🛑 止损",ai_take:"🎯 目标",ai_title:"Sonar",ai_trade_hint:"资金流评分。非投资建议。",ai_w1h:"1时",ai_w24:"24小时",ai_w30:"30天",ai_w6h:"6时",ai_w7:"7天",ai_why:"原因",ai_why_breadth:"许多钱包",ai_why_flow:"净流向",ai_why_lev:"杠杆",ai_why_liq:"池流动性",ai_why_liqskew:"清算偏斜",ai_why_oi:"未平仓",ai_why_rsi:"RSI",ai_why_share:"不是单鲸",ai_why_top:"流向中的前100",ai_why_topdir:"头部方向",ai_why_vol:"成交量",alert_add_liquidity:"添加流动性",alert_amount:"金额",alert_arbitrage:"套利",alert_avg_entry:"平均成本",alert_bridge_in:"跨链转入",alert_bridge_out:"跨链转出",alert_buy:"买入",alert_buy_price:"买入价",alert_collect_fees:"收取手续费",alert_contract:"合约",alert_prior_ago:"前",alert_prior_buy:"上次买入",alert_qty:"数量",alert_received:"收入",alert_remove_liquidity:"移除流动性",alert_sell:"卖出",alert_sell_price:"卖出价",alert_spent:"支出",alert_token:"代币",alert_trade_pnl:"交易盈亏",alert_transaction:"交易",alert_transfer:"转账",alert_unwrap:"UNWRAP",alert_wallet:"钱包",alert_wrap:"WRAP",already_tracking:"⚠️ 您已在跟踪该钱包。",already_tracking_retry:`⚠️ 您已在跟踪该钱包。

请输入其他地址或点取消。`,back_button:"← 返回",big_btn_liq:"💀 最大清算",big_btn_perp:"🔵 最大持仓",big_btn_spot:"🟡 最大买入 / 卖出",big_empty:"该时段暂无交易。",big_liq_account_was:"账户余额",big_liq_closed_at:"平仓价",big_liq_loss:"亏损",big_liq_position:"仓位",big_liq_title:"最大清算 · Hyperliquid",big_menu_hint:"被追踪钱包的最大单笔交易。选择市场：",big_perp_title:"最大持仓",big_spot_title:"最大买入 / 卖出",big_title:"分析",big_track_btn:"追踪",big_win_1h:"1 小时",big_win_24h:"24 小时",big_win_30d:"30 天",big_win_7d:"7 天",cancel_button:"❌ 取消",err_invalid_address:"❌ 钱包地址无效。",err_invalid_number:"❌ 数字无效。",err_invoice_failed:"❌ 无法创建账单。请稍后再试。",err_loading_wallet:"❌ 加载钱包出错。",err_loading_wallets:"❌ 加载钱包列表出错。",err_name_empty:`❌ 名称不能为空。

请输入名称或点取消。`,err_name_too_long:`❌ 名称过长（最多 32 个字符）。

请缩短或点取消。`,err_threshold_decimals:"❌ 最多 2 位小数（如 7500.50）。",err_threshold_positive:"❌ 阈值必须为正数。",err_threshold_too_large:"❌ 阈值过高。",err_threshold_too_small:"❌ 最低提醒阈值为 $50。请输入 $50 或更高。",err_user_limit:"⚠️ 已达用户上限。请稍后再试。",err_wallet_not_found:"❌ 列表中找不到该钱包。",flow_bought:"买入",flow_btn:"🔥 巨鲸在买什么",flow_buys:"买入",flow_coins:"币种",flow_empty:"该时段暂无数据。",flow_hint:"净流入：买入减卖出",flow_search_btn:"🔍 查找币种",flow_search_none:"该时段未找到。",flow_search_prompt:"发送代号 — 例如 PEPE",flow_sells:"卖出",flow_sold:"卖出",flow_title:"巨鲸在买什么",flow_total_buys:"买入",flow_total_sells:"卖出",flow_wallets:"钱包",free_plan_1_wallet:"⚠️ 免费版仅 1 个钱包。高级版 — 菜单中点 ⭐ 高级版。",fund_apr:"年化：",fund_btn:"💢 资金费失衡",fund_empty:"当前没有明显异常。",fund_hint:"当前一方向另一方支付最多的地方",fund_loading:"正在加载数据，请稍后再打开。",fund_longs_pay:"多头支付",fund_min_ago:"分钟前",fund_oi:"持仓",fund_shorts_pay:"空头支付",fund_title:"资金费失衡",fund_updated:"更新于",fund_vol:"成交额",generic_error_retry:"❌ 出错了，请重试。",help_channel:"📢 频道：t.me/WalletTrackerOfficial",help_commands:"使用菜单按钮：",help_disclaimer:`⚠️ 免责声明
...
当前阈值：`,toast_already_tracking:"✅ 已在跟踪",toast_invalid_address:"❌ 地址无效。",toast_main_wallet_set:"主钱包已更新",toast_wallet_removed:"✅ 钱包已删除",ton_invoice_footer:"转账后一分钟内高级版自动开启。账单有效期 1 小时。",ton_invoice_header:`💎 GRAM 支付 — $3.99
...
所有钱包、Hyperliquid 合约和完整 Top-100 已恢复。`,ton_rate_unavailable:"⚠️ 当前无法获取 GRAM 汇率，账单未创建。请稍后再试或使用 Stars 支付。",ton_scam_note:"🔒 这些信息仅在本机器人内有效。我们绝不会私聊索要付款。",ton_step_address:"地址",ton_step_amount:"金额",ton_step_memo:"备注 — 必填",ton_step_network:"网络",ton_support_note:"付款未到账？联系 @WalletTrackerHelp 并附上备注中的代码。",track_name_prompt:"🏷 请为该交易者命名：",track_now_tracked:"✅ 钱包",track_now_tracked_suffix:"正在跟踪。",trial_granted:`🎁 7 天高级版 — 赠送

您获得：Hyperliquid 合约排名、提醒与仓位，最多 50 个钱包，完整 Top 100，优先提醒。

每账户一次。`,ui_buy_pressure:"买盘占比",ui_chart:"图表",ui_chg24:"24 小时涨跌",ui_copied:"地址已复制",ui_copy:"复制",ui_copy_failed:"复制失败",ui_free_slots:"剩余名额",ui_hip3:"股票",ui_loading:"加载中",ui_locked:"高级版可用",ui_more:"更多",ui_no_signals:"该时间窗内没有信号",ui_nothing:"暂时没有内容",ui_offline:"无法连接服务器",ui_open_bot:"打开机器人",ui_pay_in_bot:"付款在机器人聊天中完成 — 小程序无法开具账单。",ui_portfolio:"投资组合",ui_pulse:"巨鲸脉搏 · 24 小时",ui_retry:"重试",ui_rot_hint:"资金从哪个币流出、又流入哪个币",ui_rotation:"轮动",ui_save:"保存",ui_saved:"已保存",ui_set_main:"设为主钱包",ui_sync_failed:"刷新失败",ui_tf_15m:"15分",ui_tf_1d:"1天",ui_tf_1h:"1小时",ui_tf_1mo:"1月",ui_tf_1w:"1周",ui_tf_4h:"4小时",ui_to_liq:"距强平",ui_updated:"已更新",ui_wallet_count:"个钱包",unit_day:"天",unit_hour:"时",unit_min:"分",unit_sec:"秒",unknown_command:"🤔 请使用下方菜单。",wallet_bot_banned:`🤖 这是交易机器人：每天数百笔交易，不在排行榜内。追踪没有意义。
